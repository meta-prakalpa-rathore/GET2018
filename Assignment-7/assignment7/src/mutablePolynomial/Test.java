...
public class Test {
    ...
    public void evaluateTest1() {
        MutablePoly polynomial = new MutablePoly(new int[][]{{2, 200}, {3, 1}, {2, 0}});
    ...
    public void evaluateTest2() {
        MutablePoly polynomial = new MutablePoly(new int[][]{{2, 2}, {3, 1}, {2, 0}, {4, 1}});
    ...
    public void degreeTest() {
        ...
        MutablePoly polynomial = new MutablePoly(new int[][]{{2, 2}, {3, 1}, {2, 0}});
    ...
    public void addPolyTest() {
        ...
        MutablePoly polynomial1 = new MutablePoly(new int[][]{{2, 2}, {3, 1}, {2, 0}});
        MutablePoly polynomial2 = new MutablePoly(new int[][]{{4, 3}, {3, 1}});
        
        MutablePoly result = MutablePoly.addPoly(polynomial1, polynomial2);
        assertArrayEquals(new int[][]{{2, 0}, {6, 1}, {2, 2}, {4, 3}}, result.getPolynomial());
        
        MutablePoly polynomial3 = new MutablePoly(new int[][]{{2, 2}});
        MutablePoly polynomial4 = new MutablePoly(new int[][]{{4, 3}, {3, 1}});
        
        result = MutablePoly.addPoly(polynomial3, polynomial4);
    ...
    public void multiplyPolyTest() {
        ...
        MutablePoly result = MutablePoly.multiplyPoly(polynomial1, polynomial2);
