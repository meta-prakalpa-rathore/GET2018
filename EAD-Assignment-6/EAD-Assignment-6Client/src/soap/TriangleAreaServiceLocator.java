...
public class TriangleAreaServiceLocator extends org.apache.axis.client.Service implements soap.TriangleAreaService {
    ...
    private java.lang.String TriangleArea_address = "http://localhost:8080/EAD-Assignment-6/services/TriangleArea";
    ...
    public soap.TriangleArea getTriangleArea() throws javax.xml.rpc.ServiceException {
    ...
    public soap.TriangleArea getTriangleArea(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            soap.TriangleAreaSoapBindingStub _stub = new soap.TriangleAreaSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (soap.TriangleArea.class.isAssignableFrom(serviceEndpointInterface)) {
                soap.TriangleAreaSoapBindingStub _stub = new soap.TriangleAreaSoapBindingStub(new java.net.URL(TriangleArea_address), this);
                _stub.setPortName(getTriangleAreaWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://soap", "TriangleAreaService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://soap", "TriangleArea"));
        }
